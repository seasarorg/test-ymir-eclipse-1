...
//
//    private ExtendedContext mvnContext;
//
...
//
//    public FragmentSelectionControl(Composite parent, Shell parentShell, IRunnableContext runnableContext,
//            ExtendedContext mvnContext) {
//        this.parent = parent;
...
//
//        try {
//            runnableContext.run(true, false, op);
//            return fragmentArtifact[0];
//        } catch (InvocationTargetException ex) {
//            Throwable realException = ex.getTargetException();
//            MessageDialog.openError(parentShell, "Error", realException.getMessage()); //$NON-NLS-1$
//            return null;
...
//            if (version == null) {
//                version = artifactResolver.getLatestVersion(mvnContext, groupId, artifactId, useFragmentSnapshot);
//                if (version == null) {
//                    return null;
//                }
//            }
//            monitor.worked(1);
//
//            return artifactResolver.resolve(mvnContext, groupId, artifactId, version);
//        } finally {
//            monitor.done();
//        }
//    }
